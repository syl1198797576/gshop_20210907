<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <i class="content-icon" @click="showMsg1 = !showMsg1"></i>
        </h2>
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      ...
      <div class="discounts-right" @click="showMsg2 = !showMsg2">
        {{ info.supports.length }} 个优惠
      </div>
    </div>
    <transition name="switch">
      <div class="shop-brief-modal" v-if="showMsg1">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showMsg1 = !showMsg1">
    ...
    <div class="activity-sheet" v-if="showMsg2">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          ...
          <li class="activity-item" :class="supportsClass[info.supports[1].type]">
                        <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="showMsg2 = !showMsg2">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
